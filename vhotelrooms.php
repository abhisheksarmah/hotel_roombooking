...
<body>
	...
	?>
	<div class="w3-container w3-light-gray w3-round-medium" style="width:80%; margin:32px auto;">
		<h3 align="center" class="w3-bottombar">HOTEL ROOMS</h3>
		<div class="w3-container" style="padding-bottom:16px;">
			<h5 style="padding-left:32px;"><strong>Hotel Name: <?php echo $hotel; ?></strong></h5>
			<div class="w3-row-padding">
				<?php
				$sql = "Select * from rooms where hotelid='$hid'";
				$result = mysqli_query($con, $sql);
				while ($row = mysqli_fetch_array($result)) {
					echo '<div class="w3-half w3-small">
			  			<div class="w3-container w3-padding-16 w3-white" style="margin-bottom:16px;">
							<img src="' . $row["photo"] . '" class="w3-card" style="width:100%; max-height:220px; margin-bottom:4px;"><br>
                            <strong>Room Type:</strong> ' . $row["roomtype"] . '&nbsp;&nbsp;&nbsp;&nbsp;<strong>Room Rate:</strong> Rs. ' . $row["rate"] . '.00
                            <br><strong>Total No. of Rooms:</strong> ' . $row["nor"] . '&nbsp;&nbsp;&nbsp;<strong>Room capacity:</strong> ' . $row["guests"] . '<br>';

					echo '<br><br>
							<a href="editroom.php?id=' . $row[0] . '&hid=' . $hid . '" class="w3-btn w3-round w3-green w3-tiny">Edit Room</a>
