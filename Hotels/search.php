    ...
    <div class="w3-display-topmiddle" style="width:100%;">
    	<div class="w3-container w3-padding-12 w3-card w3-white w3-opacity-min">
            <div class="w3-left" style="width:50%;"> 
            	<a href="index.php"><img src="images/logo.jpg" style="width:40%;"></a>
            </div>
        ...
        <div class="w3-container w3-padding-12 w3-card w3-light-gray w3-opacity-off w3-center w3-round-medium" style="width:90%; margin:12px auto;">
            	...
            	<div class="w3-container">
                    ...
                    <div class="w3-left" style="width:10%; margin-left:10px;">
                        ...
                        <input type="number" id="nor" name="nor" class="w3-input w3-border" value="<?php echo $nor; ?>">
                    </div>
                    <div class="w3-left" style="width:10%; margin-left:10px;">
                        <label>No. of Guest</label>
                        <input type="number" id="nog" name="nog" class="w3-input w3-border" value="<?php echo $nog; ?>">
                    </div>
                    <div class="w3-left" style="width:15%; margin-left:10px; padding-top:24px;">
                        <input type="submit" name="submit" value="Search" class="w3-btn w3-block w3-red w3-round-xlarge">
                    </div>
                </div>
		...
		?>
        <div class="w3-container w3-white w3-border w3-padding-16 w3-opacity-off w3-round-large" style="width:90%; margin:16px auto;">
        	<div class="w3-row-padding">
            	...
            	<div class="w3-threequarter">
                    ...
                    <div class="w3-container w3-border w3-round w3-padding-12" style="margin-bottom:12px; display:flex;">
                        ...
                        <div class="w3-left" style="width:35%; margin-right:12px;">
                            ...
                            <span class="w3-small">Facilities Available</span><br>
                            <?php
								$str="Select A.facility,B.icon from hotelfacilities as A,icons as B where A.hotelid='$hid' and A.facility=B.facility";
								$rec=mysqli_query($con,$str);
								while($r=mysqli_fetch_array($rec))
								{
									echo '<img src="'.$r[1].'" width="20" title="'.$r[0].'">&nbsp;&nbsp;&nbsp;';	
								}
							?>
                        </div>
                        <div class="w3-left w3-center" style="width:20%; margin-right:8px; padding-top:12px;">
							...
							?>
                        	<span class="w3-red w3-circle w3-padding w3-small" style="margin-bottom:8px;"><?php echo $rating; ?>/5</span><br>
                            <div class="w3-small w3-center" style="margin-top:12px;"><?php echo $n; ?> Ratings</div>
                        </div>
                ...
                <div class="w3-quarter w3-center">
                	<span class="w3-large w3-bottombar"><strong>Select Filters</strong></span>
                    <div class="w3-container w3-left-align" style="padding-left:32px;">
                        ...
                        <p>
                        <input type="submit" name="submit" value="Search" class="w3-btn w3-red w3-block">
                        </p>
                    </div>
                </div>
            </div>
